...
/*! @brief 语义识别回调接口
 *
 * SemanticSessionDelegate 会在SemanticSession对象中注入
 */
 ...
 */
-(void)onOnlineSemanticCallback:(NSInteger)cmd data:(NSString *)data userData:(id)userData;
 ...
 * @param userData 调用语义识别时传入的自定义参数
 */
-(void)onOnlineSemanticError:(NSInteger)cmd data:(NSString *)data userData:(id)userData;
@end
